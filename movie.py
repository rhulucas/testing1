...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "https://github.com/rhulucas/testing1/blob/ronghu/a-different-language/my-google-credentials.json"
...
class Movie:
    ...
    def find_movie_review_videos(self, target_language, movie_title,):

        translate_client = translate.Client()
        translated_title = translate_client.translate(self._title, target_language=target_language)
        self._title = translated_title['translatedText']
